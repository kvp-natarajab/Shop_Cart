...
u3 = User.create({name: "raj", landmark:"Near forum Mall", phone:"7795179882", address:"Adugodi", city:"Bangalore", state:"Karnataka", country:"India", email: "admin@gmail.com", password: "12345678", password_confirmation: "12345678", role_id: r3.id}) unless User.find_by_email("admin@gmail.com")
